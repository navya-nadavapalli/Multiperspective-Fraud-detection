...
urlpatterns = [
    ...
    re_path(r'^Predict_Fraud_Detection_Type/$', remoteuser.Predict_Fraud_Detection_Type, name="Predict_Fraud_Detection_Type"),
    ...
    re_path(r'^View_Fraud_Detection_Ratio/$', serviceprovider.View_Fraud_Detection_Ratio, name="View_Fraud_Detection_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_Fraud_Detection_Status/$', serviceprovider.View_Fraud_Detection_Status, name="View_Fraud_Detection_Status"),
